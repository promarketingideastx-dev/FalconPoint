...
export default function SkyMetricWorkspace() {
  ...
  return (
    <div className="bg-background-light dark:bg-[#102219] font-display text-slate-900 dark:text-slate-100 antialiased overflow-hidden h-screen flex flex-col">
      {/* Header */}
      ...
      {/* Main Map Area */}
      <main className="relative flex-1 bg-slate-200 overflow-hidden text-left">
        ...
        <div className="absolute inset-0 z-0 bg-cover bg-center" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDD2N8AJOzO2hz1DmzCxOdcMbw3z7HMmKETtTU3rVRsc1I-0NmIkt3Qp_0NXGrxmIU8ML6tGudrrnaDCFKncAPaidbhbqqHC-bB79saFGl3lOWxkXfw-loT3IMwdUNZ20z6o76fkKgmpd5penmFGMgNLDdQMZ1Bdv1uNmV_HRPovKQc-YZXPfQuest924dQzaK5to4hR9tUe9xfSugnb35HuSi8J8XXLqQ3LJkCzxeSxUZf6UlPYmtKZd0qOxPZLOb1PSR45YbPfwY')" }}>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-48 map-polygon rounded-lg flex items-center justify-center">
            <div className="bg-white/90 px-2 py-1 rounded text-[10px] font-bold text-emerald-700 shadow-sm text-[#10B981]">4,250 sq ft</div>
          </div>
        </div>

        {/* Floating Controls */}
        <div className="absolute top-6 left-6 flex flex-col gap-2 z-10">
          <div className="glass-panel p-1 rounded-xl shadow-lg flex flex-col">
          ...
          <button className="glass-panel p-3 rounded-xl shadow-lg text-slate-700 hover:text-primary transition-colors">
            <span className="material-symbols-outlined">my_location</span>
          </button>
        </div>
        
        <div className="absolute top-6 right-6 z-10">
          <div className="glass-panel p-2 rounded-xl shadow-lg flex gap-2">
            <button className="flex items-center gap-2 px-3 py-2 bg-[#10B981] text-white rounded-lg text-sm font-semibold">
              <span className="material-symbols-outlined text-base">square_foot</span>
              <span>Measure / Medir</span>
            </button>
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-emerald-100">
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-xl font-bold text-slate-900 mb-1">Quick Quote / Cotización</h3>
                  <p className="text-sm text-slate-500">Project: Roof Analysis #7742</p>
                </div>
                <div className="text-right">
                  <span className="text-2xl font-black text-[#10B981]">$349.00</span>
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Estimated / Estimado</p>
                </div>
              </div>
              
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="bg-emerald-50 p-3 rounded-xl border border-emerald-100/50">
                  <p className="text-[10px] text-emerald-600 font-bold uppercase mb-1">Area</p>
                  <p className="text-lg font-bold text-slate-900">4,250 <span className="text-xs font-normal">sqft</span></p>
                </div>
                <div className="bg-emerald-50 p-3 rounded-xl border border-emerald-100/50">
                  <p className="text-[10px] text-emerald-600 font-bold uppercase mb-1">Pitch / Pendiente</p>
                  <p className="text-lg font-bold text-slate-900">6/12</p>
                </div>
                <div className="bg-emerald-50 p-3 rounded-xl border border-emerald-100/50">
                  <p className="text-[10px] text-emerald-600 font-bold uppercase mb-1">Confidence</p>
                  <p className="text-lg font-bold text-slate-900">98%</p>
                </div>
              </div>
              
              <div className="flex gap-3">
                <button className="flex-1 bg-[#10B981] hover:bg-[#10B981]/90 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-[#10B981]/20">
                  <span className="material-symbols-outlined">picture_as_pdf</span>
                  <span>Generate PDF / Generar PDF / Gerar PDF</span>
                </button>
      ...
      <nav className="bg-white border-t border-emerald-900/5 px-6 py-2 pb-6 flex justify-around items-center z-30">
        <Link className="flex flex-col items-center gap-1 text-[#10B981]" to="/skymetric">
        ...
        <Link className="flex flex-col items-center gap-1 text-slate-400 hover:text-emerald-600 transition-colors" to="/proposals">
